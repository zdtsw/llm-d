...
<summary><b><i>Click</i></b> to view the terminal output of <code>run_only.sh</code> using <code>guidellm</code></summary>
  ...
  Containers:
    harness:
      ...
      Image ID:      ghcr.io/llm-d/llm-d-benchmark@sha256:b5e23caa84abc80d5b2e7ff0b13ffbace07db3886799fbe6c9a05e5fc0af75a4
      Port:          <none>
      Host Port:     <none>
      Command:
        sh
  ...
  Events:
    ...
    Normal  Pulling                 2s    kubelet                  Pulling image "ghcr.io/llm-d/llm-d-benchmark:v0.5.0"
    Normal  Pulled                  2s    kubelet                  Successfully pulled image "ghcr.io/llm-d/llm-d-benchmark:v0.5.0" in 285ms (285ms including waiting). Image size: 3174696470 bytes.
