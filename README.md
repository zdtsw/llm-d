...
We currently offer four tested and benchmarked paths to help deploying large models:
...
4. [Tiered Prefix Cache Offloading](./guides/tiered-prefix-cache/README.md) - Increase cache capacity and improve TTFT by offloading prefix cache from accelerator HBM to CPU RAM, local disk, or shared storage systems including WEKA GPU Direct Storage, enabling larger cache sizes and cross-instance cache sharing.
